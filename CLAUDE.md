# Terramaps — Claude Context

## Project Overview

Terramaps is a geospatial territory management web app. Users import hierarchical geographic data (e.g., zip codes rolled up into regions), view it on an interactive map, and manage territories through selection tools (lasso polygon), layer toggling, node editing, and data visualization.
...
- DB creds: user=terramaps, password=terramaps, db=app
