...
Revision ID: 8ebb75405815
Revises: faabb954ac33
Create Date: 2026-04-17 15:34:47.031078-07:00
...
def upgrade() -> None:
    """Upgrade revisions: faabb954ac33 to 8ebb75405815."""
    ...
    op.create_table(
        ...
        sa.Column("map_id", sa.Integer(), nullable=False),
        sa.Column("job_type", sa.Enum("import", "recompute", native_enum=False), nullable=False),
...
def downgrade() -> None:
    """Downgrade revisions: 8ebb75405815 to faabb954ac33."""
    # ### commands auto generated by Alembic - please adjust! ###
