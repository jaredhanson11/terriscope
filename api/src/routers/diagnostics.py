"""Diagnostic endpoints for MVT layers and geometries."""
...
@diagnostics_router.get("/geometry-stats")
...
@diagnostics_router.get("/problematic-nodes")
...
@diagnostics_router.get("/node-stats/{node_id}")
